              ...
              <div className="form-contain">
                ...
                <div className="form-fieldwrap">
                  <div className="form-containtbox">
                    ...
                    <div className="form-row">
                      <div className="form-group is-add">
                        <label htmlFor="postalAddress">
                          Permanent/Postal Address (If different)
                        </label>
                        <input
                          type="text"
                          id="postalAddress"
                    ...
                    <h3 className="form-subheading">
                      Section 2: Availability & Media Source
                    </h3>
                    <div className="form-row">
                      <div className="form-group is-add">
                        <label htmlFor="availability">
                          How soon are you looking to undertake your first
                          shift/placement?
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="form-group is-post">
                        <label htmlFor="milesWillingToTravel">
                    ...
                    <div className="form-group">
                      <div className="checkbox-group-three">
                        <label className="is-add">
                          Are you currently working or registered with any other
                          agency or contracted to provide services to any
                          organization? If yes, please provide details below.
                          Please ensure to update RIVET JOBS if this changes.
                        </label>
                      ...
                      <div className="form-row">
                        <div className="form-group">
                          <label htmlFor="referralSource">
                            Name of the site/publication/event/person:
                          </label>
                          <input
                            type="text"
                            id="referralSource"
