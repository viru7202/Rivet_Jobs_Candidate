          ...
          <div className="main-box-editprofile">
            <div className="heding-profile">
              <h3 style={{ textAlign: "center" }}>
                ...
                <p>(Please provide your last 3 years of Employment History)</p>
              </h3>
            ...
            <div className="row">
              ...
              <div className="col-md-4">
                ...
                <div className="email-input">
                  <input type="text" placeholder="Referee Name"></input>
                </div>
              </div>
              ...
              <div className="col-md-4">
                ...
                <div className="email-input">
                  <input type="text" placeholder="Referee Position"></input>
                </div>
              </div>
              ...
              <div className="col-md-4">
                ...
                <div className="email-input">
                  <input type="text" placeholder="Referee Email"></input>
                </div>
              </div>
