...
export default function ReferredCompany() {
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div className="notification">
              ...
              <button className="ref-btt" onClick={handleShow}>
                <img src="Group (5).png" alt="" style={{ paddingRight: '10px' }} />
                <span style={{ position: "relative", top: '-7px' }}>
Refer a Company</span>
              </button>
            </div>
      ...
      {/* 
Refer a Company Modal */}
      <Modal show={show} onHide={handleClose} centered>
        <Modal.Header closeButton>
          <Modal.Title>
Refer a Company</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <form>
            ...
            <div className="form-group mt-3">
              ...
              <input type="text" className="form-control" placeholder="80005 50008" />
            </div>
            <div className="form-group mt-3">
              <label>Link</label>
              <input type="text" className="form-control" placeholder="https://www.w3.org/Provider/Style/dummy.html" />
            </div>
            <Button variant="primary" type="submit" className="mt-3" style={{ width: '100%', background:'#1D71B7',  }}>
              Send
            </Button>
          </form>
        </Modal.Body>
